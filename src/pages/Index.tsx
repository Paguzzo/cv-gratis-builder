          ...
          <div className="border-t border-gray-700 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-gray-400">
            ...
            <div className="mt-6 sm:mt-8 pt-4 border-t border-gray-800">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-all duration-300 text-gray-300 hover:text-white group"
                aria-label="Visite LocalizaCEP - Consulta de CEP online"
              >
                <svg
                ...
                <span className="text-xs sm:text-sm">
                  Precisa consultar CEP? Conheça o <strong className="font-semibold">LocalizaCEP.com</strong>
                </span>
              </a>
            </div>
          </div>
